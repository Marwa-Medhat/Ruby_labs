class ComplexNumber
    ...
    puts "the multiplication Two of complex #{multipltresult.real}+ i #{ multipltresult.imag}" 
    #####################################
    ##ADD bulk of Complex
    b=[ComplexNumber.new(3,2),ComplexNumber.new(1,7),ComplexNumber.new(1,1)]
    sumresult=ComplexNumber.new(1,1).bulk_add(b)
    puts "the sum of Complex is #{sumresult.real} + #{sumresult.imag}i"
    #################################
    ...
    puts "the multiplication of complex #{multipresult.real}+ i #{ multipresult.imag}" 
    ###############################
